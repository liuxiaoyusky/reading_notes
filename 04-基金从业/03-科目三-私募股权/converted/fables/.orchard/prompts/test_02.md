...
【源数据】
- 源 fab CJK: 327（来自源文件 line 16-23）
- 推荐故事正文字数：**500-900 字**（根据 fab 大小自适应，不要硬写 600-1200）
...
2. **Read 源文件** `converted/sections/01-股权投资基金概述/01-股权投资基金的概念和特点.md`，重点关注 line 16-23 的内容
...
4. **Write 到目标文件**：`converted/fables/01-股权投资基金概述/01-股权投资基金的概念和特点/02-（一）专业性较强.md`
5. **git commit**：
   ```bash
   cd /Users/sky/Documents/github/reading_notes
   git add "converted/fables/01-股权投资基金概述/01-股权投资基金的概念和特点/02-（一）专业性较强.md"
   git commit -m "feat: 《（一）专业性较强》—— 科目三 fable"
   ```
