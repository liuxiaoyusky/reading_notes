...
2026-06-22 拆合订完成：按用户「不要合订」要求，2 节 → 5 个独立 fable 补齐。
- 11-01 投资风险概述补 06-市场风险 / 07-信用风险 / 08-流动性风险 3 个独立 fable（与原 01-05 合订版并列保留，序号 06-08 避免覆盖原 01-05）
- 16-02 基金税收拆 01-基金自身投资活动产生的税收 / 02-投资者投资基金产生的税收 2 个独立 fab 到 02-基金税收/ 子目录
- manifest total_sections 533 → 538；filesystem 568 → 573 个 `.md` fable
- 修 08-流动性风险.md 来源注释「含 2015 年股市流动性危机案例」尾巴

## 2026-06-22T14:30:00+08:00
2026-06-22 方案 A 拆合订完成：按用户「方案 A：拆开 12-07/12-04/12-06/17-02 让 spec 1:1 对齐」要求，4 节 → 20 个独立 fab（删除 16 个原合订 fab）。
- 12-07 GIPS: 4 合订 → 9 独立 fab（01-09）
- 12-04 基金风格分析: 5 合订 → 4 独立 fab（01-04）
- 12-06 基金评价业务体系: 4 合订 → 4 独立 fab（命名对齐 spec）
- 17-02 当事人信息披露义务: 3 fab（编号 02-04）→ 3 fab（编号 01-03）
- 同轮 11-01 重新整理：删 01-投资风险概述与风险类型（节标题合订），重命名 02/06/07/08 → 04/01/02/03，让 spec 4 个子主题（01市场/02信用/03流动性/04相互作用）1:1 对齐
- 10-03 重命名 02-投资交易风险管理 → 02-投资交易过程的风险管理（spec 命名偏差）
- manifest total_sections 537 → 541（净 +4），filesystem 572 个 `.md` fable
- **spec 1:1 覆盖率：98/98 = 100%**
